...
export const Projects = ({title,year,location,images}:ProjectProps) => {
  return (
    <div>
        <div className="relative h-56 w-full transform transition-transform hover:scale-105 hover:opacity-70">
            ...
            <div className="absolute bottom-1 right-1 gap-1">
                <div className="flex gap-1">
                    <LabelWithIcon text={location} image="/location.png" alt="location"/>
                    <LabelWithIcon text={year} image="/calendar.png" alt="calendar"/>
                </div>
            </div>
        </div>
